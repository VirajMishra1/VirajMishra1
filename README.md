...
<!-- WC_START -->
the model's title favorites right now: 🇪🇸 Spain 45.4% · 🇫🇷 France 19.9% · 🇦🇷 Argentina 17.7%

live track record: **64.0% W/D/L accuracy** (64/100 scored matches, random guessing gets 33.3%). every prediction locked to git before kickoff. [full table + every scoreline](https://virajmishra1.github.io/worldcup-forecaster/)
<!-- WC_END -->
